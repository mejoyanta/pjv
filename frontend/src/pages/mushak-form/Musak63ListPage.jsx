                ...
                {loading ? (
                  ...
                  data.map((item, idx) => (
                    <tr key={item.id}>
                      ...
                      <td><span className="badge badge-secondary">{item.paymentStatus || 'N/A'}</span></td>
          ...
          <div className="modal-dialog modal-lg">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title font-weight-bold">Mushak 6.3 Challan #{viewItem.viNo}</h5>
                <button type="button" className="close" onClick={() => setIsViewOpen(false)}>&times;</button>
              </div>
              <div className="modal-body">
                <div className="row mb-2">
                  <div className="col-md-6"><strong>Company (Seller):</strong> {viewItem.companyName}</div>
                  <div className="col-md-6"><strong>Branch:</strong> {viewItem.branchName}</div>
                </div>
                <div className="row mb-2">
                  <div className="col-md-6"><strong>Date of Issue:</strong> {viewItem.date}</div>
                  <div className="col-md-6"><strong>VI / Challan No:</strong> {viewItem.viNo}</div>
                </div>
                <div className="row mb-2">
                  <div className="col-md-6"><strong>Buyer Name:</strong> {viewItem.buyer || 'N/A'}</div>
                  <div className="col-md-6"><strong>Buyer BIN / NID:</strong> {viewItem.buyerBin || 'N/A'}</div>
                </div>
                <div className="row mb-2">
                ...
                <hr />
                <div className="row mb-2">
                  <div className="col-md-4"><strong>VAT Amount:</strong> {Number(viewItem.vatAmount || 0).toLocaleString(undefined, { minimumFractionDigits: 2 })}</div>
                  <div className="col-md-4"><strong>Total Amount:</strong> <span className="text-primary font-weight-bold">{Number(viewItem.totalAmount || 0).toLocaleString(undefined, { minimumFractionDigits: 2 })}</span></div>
                  <div className="col-md-4"><strong>Payment Status:</strong> {viewItem.paymentStatus || 'N/A'}</div>
                </div>
              </div>
