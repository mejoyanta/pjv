...
import { mushak621Service } from '../../services/mushakService';

export default function Musak621ListPage() {
  ...
  useEffect(() => {
    ...
    mushak621Service.load(params)
      ...
      .catch(err => {
        console.error('Failed to load Mushak 6.2.1:', err);
        setAlert({ type: 'danger', message: 'Failed to load Mushak 6.2.1 data.' });
      })
  ...
  const handlePdfDownload = async (id) => {
    try {
      ...
      await mushak621Service.downloadPdf(id);
    } catch (err) {
  ...
  return (
    <div className="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
      <Subheader
        title="6.2.1 Mushak Forms"
        breadcrumbs={[
          { title: 'Mushak Form', url: '/mushak-form/musak-6-2-1' },
          { title: '6.2.1 Mushak Forms' }
        ]}
      />
      ...
      <div className="kt-portlet kt-portlet--mobile">
        <div className="kt-portlet__head kt-portlet__head--lg">
          <div className="kt-portlet__head-label">
            ...
            <h3 className="kt-portlet__head-title">Mushak 6.2.1 (Purchase & Sale Register)</h3>
          </div>
                ...
                {loading ? (
                  <tr>
                    <td colSpan="11" className="text-center py-5 text-muted">
                      ...
                      <div className="mt-2">Loading Mushak 6.2.1 data...</div>
                    </td>
                  </tr>
                ) : data.length === 0 ? (
                  <tr>
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title font-weight-bold">Mushak 6.2.1 Details</h5>
              ...
              <div className="modal-body">
                ...
                <div className="row mb-2">
                  <div className="col-md-6"><strong>Purchase Date:</strong> {viewItem.purchaseDate || 'N/A'}</div>
                  <div className="col-md-6"><strong>Sale Date:</strong> {viewItem.saleDate || 'N/A'}</div>
                </div>
                <div className="row mb-2">
                  <div className="col-md-6"><strong>Bill of Entry:</strong> {viewItem.billOfEntry || 'N/A'}</div>
                ...
                <div className="row mb-2">
                  <div className="col-md-12"><strong>Sale Amount:</strong> <span className="text-primary font-weight-bold">{Number(viewItem.sale || 0).toLocaleString(undefined, { minimumFractionDigits: 2 })}</span></div>
                </div>
              </div>
