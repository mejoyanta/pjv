...
export const materialService = {
  ...
  getFormData: (companyId) => api.get('/materials/form-data', { params: companyId ? { companyId } : {} }),
...
export const productService = {
  ...
  getFormData: (companyId) => api.get('/products/form-data', { params: companyId ? { companyId } : {} }),
